...
import { CommonHeader, Touchable, Input, CommonButton } from '../../../components';
			...
			<KeyboardAwareScrollView
				...
				<Touchable
					...
					<Input
						...
						placeholderTextColor="#999"
					/>
					{pswConfirmRule && <TextM style={styles.pswTip}>{i18n.t('login.pswFormatErr')}</TextM>}
					{pswDifferent && <TextM style={{ color: "red", ...Gstyle.marginArg(pTd(20)) }}>{i18n.t('login.inconsistent')}</TextM>}
					<TextS style={{ color: Colors.fontGray, marginTop: pTd(20) }}>*{i18n.t('login.usernameTips')}</TextS>
